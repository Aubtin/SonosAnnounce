...
function socialGoogleLogin() {
  ...
  var getRequestURL = "https://sonosannounce-development.auth.us-west-2.amazoncognito.com/oauth2/authorize?response_type=code&client_id=7nl0dnqfskprvbbr69jf4viqqm&redirect_uri=http://localhost:3000/&state=STATE&identity_provider=Google&scope=phone+openid+profile+email+aws.cognito.signin.user.admin";
